...
const Footer = () => {
    return (
        <div className="container  mt-24">
            ...
            <footer className="footer py-4 flex flex-wrap md:flex-nowrap items-center gap-4">

                <p className="grow flex items-center justify-center text-center md:text-left text-sm text-gray-500">
                    Copyright © {new Date().getFullYear()}{" "}
                    <span style={{ color: "#FF7967" }} className="font-semibold">
                        SpaceZee
                    </span>
                </p>
                ...
                <nav className="flex gap-4 justify-center md:justify-end footerSocialIcon">
                    <a>
                        <svg
                            ...
                            height="24"
                            viewBox="0 0 24 24"
                            className="fill-current text-gray-700 hover:text-red-500 transition duration-200"
                        >
